const config = {
    ...
    mongoHost: getConf("MONGO_HOST", "46.101.114.171"),
    mongoPort: getConf("MONGO_PORT", "27017"),
    mongoUser: getConf("MONGO_USER", "medion_node_object_builder_service"),
    mongoPassword: getConf("MONGO_PASSWORD", "Weipheingo7aeCho"),
    mongoDatabase: getConf("MONGO_DATABASE", "medion_node_object_builder_service"),
