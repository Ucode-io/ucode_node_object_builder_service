...
let excelStore = {
    ...
    ExcelToDb: catchWrapDb(`${NAMESPACE}.create`, async (req) => {
        ...
        try {
            try {
                fileStream = fs.createWriteStream(createFilePath);
                ...
                // Handle the error appropriately, and consider throwing an exception or returning a rejection.
                throw error;
            }
            await new Promise((resolve, reject) => {
                fileStream.on('finish', resolve);
            ...
            try {
                ...
                console.error('Failed to clean up Excel file:', cleanupError);
            }
            throw error;
        }
    }),
