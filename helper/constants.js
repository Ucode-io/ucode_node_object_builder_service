module.exports = {
    ...
    MIXED_TYPES: ["MULTISELECT", "LOOKUPS", "DYNAMIC", "FORMULA", "FORMULA_FRONTEND", "LANGUAGE_TYPE", "MULTI_IMAGE"],
    ...
    ACTION_TYPES: ["CREATE", "UPDATE", "DELETE", "BULKWRITE", "GET", "LOGIN", "DELETE ITEM", "CREATE ITEM", "UPDATE ITEM", "CREATE TABLE", "UPDATE TABLE", "DELETE TABLE", "CREATE MENU", "DELETE MENU", "UPDATE MENU", "CREATE FIELD", "UPDATE FIELD", "DELETE FIELD", "CREATE VIEW", "DELETE VIEW", "UPDATE VIEW", "CREATE RELATION", "DELETE RELATION", "UPDATE RELATION", "DELETE LAYOUT", "UPDATE LAYOUT"],
    ACTION_TYPE_MAP: {
        "CREATE": "CREATE", 
        "UPDATE": "UPDATE", 
        "DELETE": "DELETE",
