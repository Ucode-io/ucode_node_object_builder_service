module.exports = {
    // JS TYPES
    STRING_TYPES: ["PERSON","SINGLE_LINE", "MULTI_LINE", "PICK_LIST", "DATE", "LOOKUP", "EMAIL", "PHOTO", "PHONE", "UUID", "DATE_TIME", "TIME", "INCREMENT_ID", "RANDOM_NUMBERS", "PASSWORD", "FILE", "CODABAR", "INTERNATIONAL_PHONE", "DATE_TIME_WITHOUT_TIME_ZONE", "CODE", "QR", "POLYGON"],
    NUMBER_TYPES: ["NUMBER", "FLOAT", "FLOAT_NOLIMIT"],
    BOOLEAN_TYPES: ["CHECKBOX", "SWITCH"],
    MIXED_TYPES: ["MULTISELECT", "LOOKUPS", "DYNAMIC", "FORMULA", "FORMULA_FRONTEND", "LANGUAGE_TYPE", "MULTI_IMAGE", "MONEY", "MULTI_FILE"],
