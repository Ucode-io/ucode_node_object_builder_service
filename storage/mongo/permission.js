...
let permission = {
    ...
    getFieldPermissions: catchWrapDbObjectBuilder(`${NAMESPACE}.getFieldPermissions`, async (req) => {
        try {
            ...
            const permissionTable = (await ObjectBuilder(true, req.project_id, false, false))["field_permission"]
    ...
    getViewRelationPermissions: catchWrapDbObjectBuilder(`${NAMESPACE}.getViewRelationPermissions`, async (req) => {
        ...
        const relationPermissionTable = (await ObjectBuilder(true, req.project_id, false, false))["view_relation_permission"]
