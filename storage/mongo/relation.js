...
let relationStore = {
    ...
    create: catchWrapDb(`${NAMESPACE}.create`, async (data) => {
        try {
            ...
            await History.create({ action_source: VERSION_SOURCE_TYPES_MAP.RELATION, action_type: ACTION_TYPE_MAP.CREATE, current: struct.encode(JSON.parse(JSON.stringify(relation))), is_used: { [data.env_id]: true } })
    ...
    update: catchWrapDb(`${NAMESPACE}.update`, async (data) => {
        try {
            ...
            await History.create({ action_source: VERSION_SOURCE_TYPES_MAP.RELATION, action_type: ACTION_TYPE_MAP.UPDATE, current: struct.encode(JSON.parse(JSON.stringify(relation))), previus: struct.encode(JSON.parse(JSON.stringify(beforeUpdate))), is_used: { [data.env_id]: true } })
    ...
    delete: catchWrapDb(`${NAMESPACE}.delete`, async (data) => {
        try {
            ...
            await History.create({ action_source: VERSION_SOURCE_TYPES_MAP.RELATION, action_type: ACTION_TYPE_MAP.DELETE, current: {}, previus: struct.encode(JSON.parse(JSON.stringify(relation))), is_used: { [data.env_id]: true } })
