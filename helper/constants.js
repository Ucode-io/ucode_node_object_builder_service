module.exports = {
    ...
    ACTION_TYPES: ["CREATE", "UPDATE", "DELETE", "BULKWRITE", "GET", "LOGIN", "DELETE ITEM", "CREATE ITEM", "UPDATE ITEM", "CREATE TABLE", "UPDATE TABLE", "DELETE TABLE", "CREATE MENU", "DELETE MENU", "UPDATE MENU", "CREATE FIELD", "UPDATE FIELD", "DELETE FIELD"],
    ACTION_TYPE_MAP: {
        "CREATE": "CREATE", 
        "UPDATE": "UPDATE", 
        "DELETE": "DELETE",
